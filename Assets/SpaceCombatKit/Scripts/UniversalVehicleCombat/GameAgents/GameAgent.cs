...
namespace VSX.UniversalVehicleCombat
{
    ...
    /// </summary>
    public delegate void OnAgentChangedActivationStateEventHandler(GameAgent agent, GameAgentActivationState newActivationState);
    ...
    public class GameAgent : MonoBehaviour 
	{
        ...
        public virtual void EnterVehicle(Vehicle newVehicle)
		{
			...
			if (!registered && GameAgentManager.Instance != null)
			{
        ...
        public virtual void SetActivationState (GameAgentActivationState newActivationState)
        {
            ...
            {
                onAgentChangedActivationStateEventHandler(this, newActivationState);
            }
