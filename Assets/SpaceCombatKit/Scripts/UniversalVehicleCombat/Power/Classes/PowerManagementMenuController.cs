...
namespace VSX.UniversalVehicleCombat
{
	...
	public class PowerManagementMenuController : MonoBehaviour 
	{
        ...
        {
            if (newGameState == GameState.PowerManagementMenu)
            {
        ...
        /// <summary>
        /// Called when the player shifts the power ball.
        /// </summary>
        /// <param name="inputAmountVertical">How fast to move vertically (0 - 1)</param>
        /// <param name="inputAmountHorizontal">How fast to move horizontally (0 - 1)</param>
		public void MovePowerBall (float inputAmountVertical, float inputAmountHorizontal)
        {

            powerBallPosition += inputAmountVertical * Vector3.up * powerAdjustSpeed * Time.unscaledDeltaTime;
            powerBallPosition += inputAmountHorizontal * Vector3.right * powerAdjustSpeed * Time.unscaledDeltaTime;
