	...
	public class HUDSceneManager : MonoBehaviour 
	{
		...
		public void OnFocusedVehicleChanged(Vehicle newFocusedVehicle)
		{
			...
			if (newFocusedVehicle != null && newFocusedVehicle.HUDPrefab != null)
			{
                ...
                Transform cameraTransform = vehicleCamera != null ? vehicleCamera.HUDCamera.transform : Camera.main.transform;
				loadableHUDs[selectedHUDIndex].createdInstance.OnActivate(newFocusedVehicle, cameraTransform);
