...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class SpaceVehicleEngines2 : Subsystem, IVehicleController 
	{
        ...
        void Awake()
		{
            ...
            if (hasEngineAudio && GameStateManager.Instance.CurrentGameState != GameState.Gameplay)
            {
        ...
        void OnGameStateChanged(GameState newState)
        {
            ...
            {
                if (hasEngineAudio) engineAudio.gameObject.SetActive(false);
            }
            else
            {
                if (hasEngineAudio)
